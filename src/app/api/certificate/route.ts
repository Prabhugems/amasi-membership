...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // PII (email, mciNumber) intentionally omitted from this public endpoint.
    // The certificate is generated by AMASI-number lookup with no auth, so
    // the body must not leak contact details or registration numbers.
    return Response.json({
      status: true,
      certificate: {
